...
<%!
    ...
    */  
    ...
    public static PrivateKey loadSplMctPrivateKeyPKCS8()
    {
        ...
        String filePath = "C:\\dev\\kcp_sample\\spl_test\\WebContent\\certificate\\splPrikeyPKCS8.pem";
...
<%
    ...
    */
    ...
    if ( "0000".equals(res_cd) )
    {
        ...
        ordr_idxx = f_get_parm((String)json_res.get("order_no"));
        res_cd    = f_get_parm((String)json_res.get("res_cd"));
        res_msg   = f_get_parm((String)json_res.get("res_msg"));
...
<body oncontextmenu="return false;">
    <div class="wrap">
        ...
        <div id="skipCont" class="contents">
            ...
            <ul class="list-type-1">
                <li>
                    <div class="left"><p class="title">발급서 코드</p></div>
                    <div class="right">
                        <div class="ipt-type-1 pc-wd-2">
                            <%=tk_van_code %>
                        </div>
